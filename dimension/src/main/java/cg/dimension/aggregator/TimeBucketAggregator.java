...
public class TimeBucketAggregator<B, AV extends Number> extends GeneralAggregator<B, Long, AV, Range<Long>>
{
      ...
      long bucketBeginTime, long bucketTimeSpan)
  {
    ...
    PropertyCriteria<B, Long, Range<Long>> criteria = new PropertyCriteria<B, Long, Range<Long>>(matchValueGenerator, matcher);
